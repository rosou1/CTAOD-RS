...
from detectron2.modeling import GeneralizedRCNNWithTTA, add_swint_config,add_SpectralAdapter_config
...
def build_evaluator(cfg, dataset_name, output_folder=None):
    ...
    if evaluator_type in ["coco", "coco_panoptic_seg"]:
        # 用于控制不显示adapter缺失参数的报�?        logging.getLogger("fvcore.common.checkpoint").setLevel(logging.ERROR)
...
def setup(args):
    ...
    add_SpectralAdapter_config(cfg)
